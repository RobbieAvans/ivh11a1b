...
public class DefaultHallReservationPriceStrategy implements HallReservationPriceStrategy {
	...
	public DefaultHallReservationPriceStrategy(HallPriceStrategy hallPriceStrategy, HallOptionPriceStrategy hallOptionPriceStrategy) {
	...
	public double calculateInVat(HallReservation hallReservation) {
        return calculateExVat(hallReservation) * 1.21;
	}
